...
<%
	...
	if(loginSuccess == true)
	{
		...
		<%  
		/*request.setAttribute("userLogin", loginValue);
		request.setAttribute("userName", ph.userName);
		request.getRequestDispatcher("UserOptions.jsp").forward(request, response);*/
